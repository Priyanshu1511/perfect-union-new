    ...
    <div className="">
              ...
              <div>
                ...
                <div className="space-y-8">
                  ...
                  <div className="flex items-start">
                    ...
                    <div className="ml-4">
                      <h3 className="text-lg font-bold text-slate-900 mb-1">Business Hours</h3>
                      <p className="text-slate-600">Monday to Friday: 9:00 AM - 5:30 PM EST</p>
      ...
      <section className="py-24 px-4 bg-gray-50">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-slate-600 mb-8 leading-relaxed">
              With extensive experience in commercial trucking insurance, our team has the knowledge and expertise to provide the coverage your business needs.
          </p>
          <div className="grid md:grid-cols-3 gap-8 text-center">
            <div>
              <div className="text-5xl font-bold text-slate-900 mb-2">Fast</div>
