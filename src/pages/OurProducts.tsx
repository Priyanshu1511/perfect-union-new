  ...
  const products = [
    {
      ...
      description: 'Our tailored truck insurance includes Auto Liability, Motor Truck Cargo, Auto Physical Damage, and General Liability coverage to protect your business from accidents, vehicle damage, cargo loss, theft, and liability exposures on the road.',
      features: [
    ...
    },
    {
      ...
      description: 'Physical damage insurance covers repair or replacement costs if your business vehicles are damaged by collisions, theft, fire, vandalism, or weather events. Designed for single trucks or fleets, it protects your investment, minimizes unexpected expenses, and helps your business recover quickly so you can stay on the road.',
      features: [
    ...
    },
    {
      ...
      description: 'Protect your vehicle and peace of mind with our comprehensive car insurance options. Whether you’re looking for basic coverage or a more tailored plan, we offer flexible policies to meet your needs.',
      features: [
