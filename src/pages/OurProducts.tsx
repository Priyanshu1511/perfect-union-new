            ...
            {products.map((product, index) => (
              ...
              >
                ...
                <div className={index % 2 === 1 ? "md:order-2" : ""}>
                  ...
                  <button className="hidden md:block bg-slate-900 text-white px-4 py-2 text-sm rounded-md hover:bg-slate-800 transition-colors duration-200" onClick={() => onNavigate('contact' , 'contact-form')}>
                    Learn More
                  </button>
                </div>
